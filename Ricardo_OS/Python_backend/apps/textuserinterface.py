...
flag_lookup[22] = ['error','ORIENTATION']
flag_lookup[23] = ['warn','BATT']
flag_lookup[24] = ['warn','PYRO1']
flag_lookup[25] = ['warn','PYRO2']
flag_lookup[26] = ['flightphase','BOOST']
flag_lookup[27] = ['flightphase','COAST']
flag_lookup[28] = ['flightphase','APOGEE']
flag_lookup[29] = ['flightphase','DROGUE CHUTE']
flag_lookup[30] = ['flightphase','MAIN CHUTE']
