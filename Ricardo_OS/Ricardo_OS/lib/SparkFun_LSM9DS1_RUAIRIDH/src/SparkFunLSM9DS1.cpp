...
uint16_t LSM9DS1::beginSPI(uint8_t sck, uint8_t miso, uint8_t mosi, uint8_t ag_CS_pin, uint8_t m_CS_pin)
{
	// Set device settings, they are used in many other places
...
void LSM9DS1::initSPI(uint8_t sck, uint8_t miso, uint8_t mosi)
{
